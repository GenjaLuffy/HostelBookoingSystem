...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $created_by_role = $_SESSION['user_role'] ?? 'admin'; // assuming you store role in session
      ...
      <div class="form-card">
        ...
        <form id="hostelForm" method="POST" enctype="multipart/form-data">
          ...
          <label for="image2" class="custom-file-upload">
            <i class="fas fa-upload"></i> Upload Additional Image 2
          </label>
          <input type="file" id="image2" name="image2" accept="image/*" style="display:none;" />

          <label for="image3" class="custom-file-upload">
            <i class="fas fa-upload"></i> Upload Additional Image 3
          </label>
          <input type="file" id="image3" name="image3" accept="image/*" style="display:none;" />

          <label for="image4" class="custom-file-upload">
            <i class="fas fa-upload"></i> Upload Additional Image 4
          </label>
          ...
          <div class="rules">
            <label><input type="checkbox" name="rules[]" value="Arrival after 14:00, departure by 12:00" /> Time of arrival is after 14:00. Time of departure is to 12:00</label>
