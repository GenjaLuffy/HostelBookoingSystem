...
$stmt = $con->prepare("SELECT id, name, username, email, dob, phone, address, gender, profile_picture, document, type, created_at FROM admins WHERE id = ?");
...
if (!empty($owner['document'])) {
    $docPath = 'document/' . $owner['document'];  // Adjust folder if needed
